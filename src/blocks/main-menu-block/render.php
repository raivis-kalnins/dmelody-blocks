<?php 
	...
	$dp_header_menu = array(
		'theme_location' 	=> 'dp-header-menu',
		'depth'             => 4,
		'container'         => false,
		'menu_class'        => '',
...
<nav class="navbar navbar-expand-md navbar-light bg-light header-nav <?= $blockClass ?>" role="navigation">
	<span class="navbar-toggler-btn" data-target="#dp-header-menu" style="display:none"><em></em><em></em><em></em></span>
	<div class="container-boxed">
		<div class="collapse navbar-collapse dp-header-menu-container" id="dp-header-menu">
			<?php wp_nav_menu( $dp_header_menu ); ?>
