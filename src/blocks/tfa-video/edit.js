...
export default function edit( { attributes, setAttributes } ) {
	...
	const wrapperClasses = classnames( 'dp-video__wrap' );
	...
	return (
		<>
			...
			<div className="dp-video" { ...blockProps }>
				<hr />
				<p className="dp-video--code"><b>YouTube URL</b> ( Current height: { srcHeight }px ): <a href={ 'https://www.youtube.com/embed/' + srcUrl } target="_blank">Open Video</a> | Path: ".../embed/{ srcUrl }"</p>
				<hr />
